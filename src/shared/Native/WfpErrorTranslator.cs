...
{
    // Common WFP-related Win32 error codes
    ...
    private static (string Code, string Message) GetErrorDetails(uint errorCode)
    {
        return errorCode switch
        {
            ...
            FWP_E_PROVIDER_NOT_FOUND => (ErrorCodes.NotFound, "The WFP provider was not found."),
            FWP_E_SUBLAYER_NOT_FOUND => (ErrorCodes.NotFound, "The WFP sublayer was not found."),
            FWP_E_FILTER_NOT_FOUND => (ErrorCodes.NotFound, "The WFP filter was not found."),
