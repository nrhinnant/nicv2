...
4. **Publishes and builds** - Publishes Service/CLI/UI first (installer depends on publish output), then builds solution
...
[4/7] Building and publishing projects in Release configuration...
       Publishing Service...
       Publishing CLI...
       Publishing UI project...
